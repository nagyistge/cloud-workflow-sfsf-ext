{
	"contents": {
		...
		"c8bb1352-a22c-44cd-a2ad-ddfb28e0fa14": {
			...
			"name": "Confirm Order",
			"documentation": "S/4 HANA sends a message back to workflow that all the equipment has been received for the particular new hire",
			"eventDefinitions": {
		...
		"a29654a9-81d1-4d88-9456-3b010d95ce10": {
			...
			"path": "/invoke?rule_service_name=OnBoarding::DetermineEquipment",
			"httpMethod": "POST",
			"xsrfPath": "/xsrf-token",
		...
		"f4cfea4b-bda6-460a-ba86-367bfca1ea2e": {
			...
			"recipientUsers": "${context.empData.buddies}, Sesh",
			"id": "usertask3",
			"name": "Accept Workplace for New Hire",
		...
		"ec942f2d-4518-4679-9ab4-996be0082459": {
			"classDefinition": "com.sap.bpm.wfs.ScriptTask",
			"reference": "/scripts/SuccessFactorsOnboarding/ProcessCo-workersList.js",
			"id": "scripttask3",
			"name": "Process Co-workers List",
		...
		"5fc45f9d-95ca-465a-bef7-1c9a53b53331": {
			"classDefinition": "com.sap.bpm.wfs.ui.SequenceFlowSymbol",
			"points": "-41.87787937930375,244 25.968326568603516,244 25.968326568603516,167.5 142.81453320262483,167.5",
			"sourceSymbol": "5551b66d-d206-46b6-b3ba-bfaa24aec0a7",
		...
		"835b4167-0eb7-4c1b-8b7e-c89a4f10d2c0": {
			"classDefinition": "com.sap.bpm.wfs.ui.SequenceFlowSymbol",
			"points": "142.81453320262483,167.25 398,167.25",
		...
		"c315fdc1-db5d-4dea-b22f-3687f3fa3804": {
			"classDefinition": "com.sap.bpm.wfs.ui.SequenceFlowSymbol",
			"points": "935,243.75 935,322.25 665.8433227539062,322.25 665.8433265686035,271.25",
			"sourceSymbol": "e12f25ee-1031-485b-aa03-79fa31597b0a",
			"targetSymbol": "997dabc6-faf5-4cfd-9cbf-00581e30e635",
		...
		"c6d7d3a8-237c-4953-9a3e-2f48f78353ea": {
			"classDefinition": "com.sap.bpm.wfs.ui.SequenceFlowSymbol",
			"points": "398,167 546,167 546,243.75",
